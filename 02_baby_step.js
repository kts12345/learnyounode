...
Run it with nodeprogram.js and some numbers as arguments.e.g:
...
'node', and the second element is always the path to your program.js file, 
so you need to start at the 3rd element (index 2), adding each item to the total 
